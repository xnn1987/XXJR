 ...
 */
public class StarFriendAdpter extends BaseAdapter {
    ...
    public StarFriendAdpter(Context context, List<Map<String, Object>> list) {
...
//                if (textWidth > (screenWidth /5)) {
//                    TextView spaceTextView = new TextView(context);//间隔
//                    spaceTextView.setText("...");
//                    viewHolder.custConcatTagText.addView(spaceTextView);
//                    break;
//                }
//                TextView spaceTextView = new TextView(context);//分割  打空格
//                spaceTextView.setText("  ");
//                viewHolder.custConcatTagText.addView(spaceTextView);

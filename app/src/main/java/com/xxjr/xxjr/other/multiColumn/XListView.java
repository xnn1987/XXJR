...
public class XListView extends MultiColumnListView implements PLA_AbsListView.OnScrollListener {
	...
	private String mSharedPrefName = "timeName";
	/** 更新间隔 ————> 10秒    ————> 转换为毫秒   */
	...
	private void initWithContext(Context context) {
		SharedPrefUtil sp = new SharedPrefUtil(getContext(),mSharedPrefName);
		mLastUpdateTimeMillis = sp.getLong(LAST_SAVE_TIME,-1);
...
//		System.out.println("getLastUpdatedText = "+_Text);
	...
	/**
	 * 判断是否要上啦加载，  如果大于摸个数量就要，如果小于就不要
	 * @param enable
	 * @param dataListSize
     */
	public void setPullLoadEnable(boolean enable , int dataListSize) {
		if (dataListSize < ConstantUtils.EVERYPAGER_10) {
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			if(mLastUpdateTimeMillis == -1){
				mHeaderTimeView.setText("未知时间更新");
			}else{
				long _TimeDiffSeconds = (System.currentTimeMillis() - mLastUpdateTimeMillis) / 1000;
				mHeaderTimeView.setText(getLastUpdatedText(_TimeDiffSeconds));
			}

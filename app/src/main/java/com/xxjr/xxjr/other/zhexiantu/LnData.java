...
public class LnData {
	...
	{				
		...
		mPlotLine.getLinePaint().setStrokeWidth(2* MyApplication.density);//  曲线 的 线宽
		mPlotLine.getDotLabelPaint().setColor(color );
		mPlotLine.getDotLabelPaint().setStrokeWidth(20* MyApplication.density);//  点的  线宽
		mPlotLine.getDotPaint().setColor(color);
		mPlotLine.getDotPaint().setStrokeWidth(2* MyApplication.density);//  点的  线宽
	}

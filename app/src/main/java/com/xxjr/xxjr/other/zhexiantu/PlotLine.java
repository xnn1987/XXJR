...
public class PlotLine {
	...
	private void initLinePaint()
	{
		if(null == mPaintLine)
		{
			...
			mPaintLine.setColor(R.color.zhexiantu_line_green);
	...
	private void initLabelPaint()
	{
		if(null == mPaintLabel)
		{
			...
			mPaintLabel.setColor(R.color.zhexiantu_line_green);
			mPaintLabel.setTextSize(10);
	...
	public Paint getDotPaint()
	{
		...
		{
			mPaintDot = new Paint();
			mPaintDot.setColor(R.color.zhexiantu_line_green);
			mPaintDot.setAntiAlias(true);
			mPaintDot.setStrokeWidth(1);
		}

...
import com.xxjr.xxjr.photo.util.ImageDisplayer;
...
public class ImageGridAdapter extends BaseAdapter
{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		{
			convertView = View
					.inflate(mContext, R.layout.photo_item_image_list, null);
		...
		if (item.isSelected)
		{
			mHolder.selectedIv.setImageDrawable(mContext.getResources()
					.getDrawable(R.drawable.photo_tag_selected));
			mHolder.selectedIv.setVisibility(View.VISIBLE);
			mHolder.selectedBgTv
					.setBackgroundResource(R.drawable.photo_image_selected);
		}
		else
		{

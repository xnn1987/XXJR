...
public class MyMemberActivity extends SlidBackActivity {
    ...
    private void initWebView() {
        webView = (ProgressWebView) findViewById(R.id.Mymenber_wv_Mymenber);
        webView.loadUrl(Urls.RANQING + Urls.MYMEMBER + "?UUID=" + MyApplication.device + "&uid=" + MyApplication.uid);

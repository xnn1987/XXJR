...
public class QuTuActivity extends SlidBackActivity implements XListView.IXListViewListener, View.OnClickListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Map<String, Object> map = CommonMath.spGetMainCache(this, ConstantUtils.SP_MAIN_QUTUFM);
        if (map != null) {
    ...
    private void downLoadCard(final boolean isDialog) {
        ...
        requestCall.execute(new MapCallback(this, isDialog) {
            ...
            public void onError(Call call, Exception e) {
                ...
                if (!isDialog) {
                    DebugLog.Toast(QuTuActivity.this, ConstantUtils.DIALOG_ERROR);
                }
            ...
            public void onResponse(Map responseMap) {
                ...
                if (responseMap != null) {
                    ...
                    if (rowsList.size() != 0) {
                        ...
                        currentPage--;
                        DebugLog.Toast(QuTuActivity.this, "没有新数据");
                    }
                    if (titleIndex == 0)
                        CommonMath.spPutMainCache(QuTuActivity.this, responseMap, ConstantUtils.SP_MAIN_QUTUFM);
                }

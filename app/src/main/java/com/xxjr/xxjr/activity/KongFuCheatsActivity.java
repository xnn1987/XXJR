...
public class KongFuCheatsActivity extends SlidBackActivity {
    ...
    private void initWebView() {
        webView = (ProgressWebView) findViewById(R.id.KFCheats_wv_Cheats);
        webView.loadUrl(Urls.RANQING + Urls.KONGFU_CHEATS);
